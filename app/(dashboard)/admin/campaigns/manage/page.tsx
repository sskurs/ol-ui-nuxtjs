...
import { Plus, Edit, Trash2, Copy, Gift, Users, Clock } from "lucide-react";
...
export default function ManageCampaignsPage() {
  ...
  // Filter campaigns by name, type, or coupon
  const filteredCampaigns = campaigns.filter((c) => {
    const q = search.toLowerCase();
    return (
      c.name.toLowerCase().includes(q) ||
      c.type.toLowerCase().includes(q) ||
      c.coupons.some((coupon) => coupon.toLowerCase().includes(q))
    );
  });
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">View, edit, duplicate, and delete your marketing campaigns</p>
          </div>
              ...
              <Card key={c.id} className="relative">
                ...
                <CardContent className="space-y-2">
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button size="sm" variant="secondary" onClick={() => handleDuplicate(c)}>
